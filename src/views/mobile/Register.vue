    ...
    <div class="bgimg">
      ...
      <div class="login-back">
        <div class="back-img" @click="Back">
          <img
            src="../../assets/mobilesite/arrowback.png"
            alt
            width="30%"
            height="30%"
          />
      ...
      <img
        src="../../assets/mobilesite/logo.png"
        alt=""
...
.bgimg {
  ...
  width: 100%;
  height: 100vh;
  background: url(../../assets/mobilesite/loginBackground.png) no-repeat center
    center #000000;
...
.wrapper {
  background-image: url(../../assets/mobilesite/Layout.png);
  background-repeat: no-repeat;
